...
function datepicker(locals) {
  ...
  if (locals.value) {
    dateValue.setHours(locals.value.getHours());
    dateValue.setMinutes(locals.value.getMinutes());
  }
                ...
                <DateTimePicker
                  ...
                  onChange={(event, date) => {
                    if (date !== undefined) {
                      ...
                      if (locals.value) {
                        newTime.setHours(locals.value.getHours());
                        newTime.setMinutes(locals.value.getMinutes());
                      }
                      newTime.setHours(date.getHours());
                      newTime.setMinutes(date.getMinutes());
                      locals.updateShowAndroid(false);
