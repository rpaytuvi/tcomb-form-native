...
class DatePicker extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    const should =
      ...
      nextProps.options !== this.props.options ||
      nextProps.type !== this.props.type ||
      nextState.showAndroid !== this.state.showAndroid;
    return should;
  }
  ...
  getLocals() {
    ...
    [
      ...
      if (name === "showAndroid") {
        locals[name] = this.state.showAndroid;
      } else if (name === "updateShowAndroid") {
        locals[name] = (showAndroid) => { this.setState({ showAndroid }); };
      } else {
        locals[name] = this.props.options[name];
      }
    });
